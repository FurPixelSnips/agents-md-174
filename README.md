...
```bash
git clone https://github.com/FurPixelSnips/agents-md-174.git
cd agents-md-174
python setup.py
```
...
see: [AGENTS.md](https://github.com/FurPixelSnips/agents-md-174/blob/main/AGENTS.md#command-output) - Command Output
...
<!-- Last updated: 2026-06-06 19:11:37 -->
